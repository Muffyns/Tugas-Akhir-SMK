...
<p>Email (opsional) &nbsp;&nbsp;&nbsp;&nbsp;:
<input placeholder="emailanda@gmail.com" type="text" name="email"/>
</p>
<p>Website (opsional) :
<input type="text" placeholder="link website" name="website"/>
</p>
<p>Pesan:
<textarea placeholder="Tulis Pesan di sini" cols="90" rows="10" name="pesan" required></textarea>
</p>
...
<?php
include("koneksi.php");
$query=mysqli_query($koneksi,'select * from optik');
